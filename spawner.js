var spawner = {
    ...
    run: function(idealHarvesterAmount, idealUpgraderAmount, idealBuilderAmount) {
        ...
        if(builders.length < idealBuilderAmount && !Game.spawns['Spawn1'].spawning) {
